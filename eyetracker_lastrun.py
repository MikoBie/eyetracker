...
trialComponents = [instrukcja, key_resp]
...
while continueRoutine:
    ...
    # *instrukcja* updates
    if instrukcja.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
